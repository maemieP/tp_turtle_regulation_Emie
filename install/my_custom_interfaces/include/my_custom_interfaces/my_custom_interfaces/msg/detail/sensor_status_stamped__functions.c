...
my_custom_interfaces__msg__SensorStatusStamped__init(my_custom_interfaces__msg__SensorStatusStamped * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    my_custom_interfaces__msg__SensorStatusStamped__fini(msg);
    return false;
  }
  // status
...
my_custom_interfaces__msg__SensorStatusStamped__create(void)
{
  ...
  my_custom_interfaces__msg__SensorStatusStamped * msg = (my_custom_interfaces__msg__SensorStatusStamped *)allocator.allocate(sizeof(my_custom_interfaces__msg__SensorStatusStamped), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_custom_interfaces__msg__SensorStatusStamped));
  bool success = my_custom_interfaces__msg__SensorStatusStamped__init(msg);
  if (!success) {
...
my_custom_interfaces__msg__SensorStatusStamped__Sequence__init(my_custom_interfaces__msg__SensorStatusStamped__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_custom_interfaces__msg__SensorStatusStamped * data = NULL;

  if (size) {
    data = (my_custom_interfaces__msg__SensorStatusStamped *)allocator.zero_allocate(size, sizeof(my_custom_interfaces__msg__SensorStatusStamped), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_custom_interfaces__msg__SensorStatusStamped__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        my_custom_interfaces__msg__SensorStatusStamped__fini(&data[i - 1]);
      }
...
my_custom_interfaces__msg__SensorStatusStamped__Sequence__fini(my_custom_interfaces__msg__SensorStatusStamped__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      my_custom_interfaces__msg__SensorStatusStamped__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_custom_interfaces__msg__SensorStatusStamped__Sequence * array = (my_custom_interfaces__msg__SensorStatusStamped__Sequence *)allocator.allocate(sizeof(my_custom_interfaces__msg__SensorStatusStamped__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_custom_interfaces__msg__SensorStatusStamped__Sequence__init(array, size);
  if (!success) {
...
my_custom_interfaces__msg__SensorStatusStamped__Sequence__destroy(my_custom_interfaces__msg__SensorStatusStamped__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_custom_interfaces__msg__SensorStatusStamped__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_custom_interfaces__msg__SensorStatusStamped__Sequence__are_equal(const my_custom_interfaces__msg__SensorStatusStamped__Sequence * lhs, const my_custom_interfaces__msg__SensorStatusStamped__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_custom_interfaces__msg__SensorStatusStamped__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_custom_interfaces__msg__SensorStatusStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_custom_interfaces__msg__SensorStatusStamped);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_custom_interfaces__msg__SensorStatusStamped * data =
      (my_custom_interfaces__msg__SensorStatusStamped *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_custom_interfaces__msg__SensorStatusStamped__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_custom_interfaces__msg__SensorStatusStamped__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_custom_interfaces__msg__SensorStatusStamped__copy(
