...
bool my_custom_interfaces__msg__sensor_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_custom_interfaces.msg._sensor_status.SensorStatus", full_classname_dest, 52) == 0);
  }
  my_custom_interfaces__msg__SensorStatus * ros_message = _ros_message;
  {  // status
...
PyObject * my_custom_interfaces__msg__sensor_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_custom_interfaces.msg._sensor_status");
