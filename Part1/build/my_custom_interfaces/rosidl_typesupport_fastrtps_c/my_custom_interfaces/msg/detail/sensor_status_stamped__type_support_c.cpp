...
#include "my_custom_interfaces/msg/detail/sensor_status_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _SensorStatusStamped__ros_msg_type = my_custom_interfaces__msg__SensorStatusStamped;
...
size_t get_serialized_size_my_custom_interfaces__msg__SensorStatusStamped(
  ...
  size_t current_alignment)
{
  const _SensorStatusStamped__ros_msg_type * ros_message = static_cast<const _SensorStatusStamped__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_custom_interfaces__msg__SensorStatusStamped;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const my_custom_interfaces__msg__SensorStatusStamped * ros_message = static_cast<const my_custom_interfaces__msg__SensorStatusStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_my_custom_interfaces__msg__SensorStatusStamped(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  my_custom_interfaces__msg__SensorStatusStamped * ros_message = static_cast<my_custom_interfaces__msg__SensorStatusStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_my_custom_interfaces__msg__SensorStatusStamped(cdr, ros_message);
}

static uint32_t _SensorStatusStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_custom_interfaces__msg__SensorStatusStamped(
...
static size_t _SensorStatusStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_custom_interfaces__msg__SensorStatusStamped(
...
static message_type_support_callbacks_t __callbacks_SensorStatusStamped = {
...
static rosidl_message_type_support_t _SensorStatusStamped__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SensorStatusStamped,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_custom_interfaces, msg, SensorStatusStamped)() {
  return &_SensorStatusStamped__type_support;
}
